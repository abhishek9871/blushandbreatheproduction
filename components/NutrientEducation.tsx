      ...
      <div className="flex items-start gap-4">
        <div className="flex-1">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
            {nutrientInfo.title || nutrientInfo.name}
          </h2>
          ...
          <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Daily Value: <span className="font-medium">{nutrientInfo.dailyValue || 'N/A'}</span>
              </div>
            </div>
            
            <div className="flex flex-wrap gap-2 mb-4">
              {(nutrientInfo.richFoodSources || nutrientInfo.sources || []).map((food, index) => (
                <span 
                  key={index}
            ...
            >
              ...
              Find {nutrientInfo.title || nutrientInfo.name} Rich Foods
            </button>
          </div>
        </div>
      </div>
