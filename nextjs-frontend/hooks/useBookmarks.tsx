...
import type { Article, Product, Tutorial, Video, NutritionInfo, TipCard, EbayProductSummary } from '@/types';
...
export const BookmarkProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Load bookmarks after mount
  useEffect(() => {
    setMounted(true);
    setBookmarkedItems(getInitialBookmarks());
  }, []);
